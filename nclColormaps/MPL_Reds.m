function [cmap] = MPL_Reds(args)
% Edited: Dec. 3rd, 2021
%
% Colormap Reference:
% https://www.ncl.ucar.edu/Document/Graphics/ColorTables/MPL_Reds.shtml
%
% ncolors = 128
% cmap = MPL_Reds()
% cmap = MPL_Reds(argumentName, argumentValue)
% 
% INPUT ARGUMENTS:
...
cmap = [[0.999877, 0.958201, 0.937486];...
    ...
    [0.96143, 0.326059, 0.232987];...
    [0.958478, 0.314494, 0.225606];...
    [0.955525, 0.30293, 0.218224];...
    ...
    [0.930058, 0.224375, 0.16955];...
    [0.9212, 0.215763, 0.165859];...
